...
See the audit's Medium/Low sections — representative, not yet an exhaustive sweep (accessibility, offline behavior, pagination, performance at scale all still need a dedicated pass). Data export is done — see Resolved below.
